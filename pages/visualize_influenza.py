...
def app():   
    ...
    st.title("Forecast Influenza Cases")
    weektoforecast = st.sidebar.number_input('Enter Number of Weeks to forecast',min_value=4)
    cases=st.sidebar.number_input('Enter Number of Cases For The Current Day for Influenza',value=0)
    ...
    loaded_model=load_model('influenza_finalmodel.h5')
