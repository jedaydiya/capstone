...
def app():   
    ...
    st.title("Forecast Mers Cases")
    weektoforecast = st.sidebar.number_input('Enter Number of Weeks to forecast',min_value=4)
    cases=st.sidebar.number_input('Enter Number of Cases For The Current Day for Mers',value=0)
    ...
    loaded_model=load_model('mers_finalmodel.h5')
